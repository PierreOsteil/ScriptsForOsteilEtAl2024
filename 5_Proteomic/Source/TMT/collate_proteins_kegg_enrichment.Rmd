...
cmp_expts_dir <- file.path(results_dir,  "TMT", "Protein_Comparisons_Exact", "KEGG")
createDirIfNotExists(cmp_expts_dir)

results_path_glob <- file.path(results_dir, "TMT/de_proteins_kegg_list/*/KEGG_table_*.tab")   
