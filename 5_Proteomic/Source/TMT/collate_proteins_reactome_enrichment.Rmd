...
cmp_expts_dir <- file.path(results_dir,  "TMT", "Protein_Comparisons_Exact", "Reactome")
createDirIfNotExists(cmp_expts_dir)

results_path_glob <- file.path(results_dir, "TMT/de_proteins_reactome_list/*/reactome_table_*.tab")   
...
purrr::walk2(list_of_names, list_of_heatmaps, 
             function(output_name, plot){   ggsave( filename=file.path(cmp_expts_dir,
                                                                       paste0(analysis_type_file_name, "_", output_name   ,".pdf")) , plot=plot, width = 15, height=20)   }  )

purrr::walk2(list_of_names, list_of_heatmaps, 
             function(output_name, plot){   ggsave( filename=file.path(cmp_expts_dir,
                                                                       paste0(analysis_type_file_name, "_", output_name, ".png")) , plot=plot, width = 15, height=20)   }  )
```
