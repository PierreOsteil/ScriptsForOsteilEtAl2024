...
cmp_expts_dir <- file.path(results_dir, "TMT", "SOMS_enrichment_graphs", "KEGG")
createDirIfNotExists(cmp_expts_dir)

results_path_glob <- file.path(results_dir, "TMT", "clustering_enrichment_kegg", "Analysis_Results", "KEGG_table_Analysis_Results.tab")
...
purrr::walk2(list_of_names, list_of_heatmaps, 
             function(output_name, plot){   ggsave( filename=file.path(cmp_expts_dir,
                                                                       paste0(analysis_type_file_name, "_", output_name   ,".pdf")) , plot=plot, width = 8, height=7)   }  )

purrr::walk2(list_of_names, list_of_heatmaps, 
             function(output_name, plot){   ggsave( filename=file.path(cmp_expts_dir,
                                                                       paste0(analysis_type_file_name, "_", output_name, ".png")) , plot=plot, width = 8, height=7)   }  )
```
